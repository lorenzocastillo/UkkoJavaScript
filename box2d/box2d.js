...
(function () {
    ...
    b2Body.prototype.GetPreviousPosition = function () {
        return this.previousPosition;
    }
    b2Body.prototype.SetPreviousPosition = function (position) {
    ...
    b2Body.prototype.SetGravityScale = function (gravityScale) {
        if (gravityScale === undefined) gravityScale = 1.0;
    ...
    b2Body.prototype.b2Body = function (bd, world) {
        ...
        this.previousPosition = bd.position;
    }
    ...
    b2DebugDraw.prototype.SetOffsets = function (XYoffset) {
        offset = {x:XYoffset.x, y:XYoffset.y}
    }
...
//        s.stroke();
        ...
        //offset.x=-(cc.Director.getInstance().getWinSize().width/2)/PTM_RATIO;
        //offset.y=(cc.Director.getInstance().getWinSize().height/2)/PTM_RATIO;
    ...
    b2DebugDraw.prototype.DrawSegment = function (p1, p2, color) {
        ...
        s.strokeStyle = this._color(color.color, this.m_alpha);
        s.beginPath();
        s.moveTo((p1.x+offset.x) * drawScale, ((p1.y*-1)+offset.y) * drawScale);
        s.lineTo((p2.x+offset.x) * drawScale, ((p2.y*-1)+offset.y) * drawScale);
        s.closePath();
        s.stroke();
    };
    b2DebugDraw.prototype.DrawTransform = function (xf) {
