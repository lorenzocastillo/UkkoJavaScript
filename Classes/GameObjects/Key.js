var Key = cc.Sprite.extend({
    ...
    ctor:function(x,y,world){
        ...
        this.setDisplayFrame(this._cache.getSpriteFrame("Key0.png"));
        this._tag=TAG.kKey;
    ...
    setUpAnimations:function(){
        this._idleAnim = this.animWithName(this._className,0,7,0.2);
        this._deathAnim = this.animWithName(this._className,8,10,0.06);
