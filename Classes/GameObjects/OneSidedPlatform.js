var OneSidedPlatform = cc.Sprite.extend({
    _currentRotation:0,
    _world : null,
    _cache : null,
    _body : null,
    ...
    createBody:function(){
        ...
        dynamicBox.SetAsOrientedBox(this.getContentSize().width*.5/PTM_RATIO, this.getContentSize().height*.05/PTM_RATIO, new b2Vec2(0,(this.getContentSize().height*.5/PTM_RATIO)-this._height*1.1),0);//These are mid points for our 1m box
